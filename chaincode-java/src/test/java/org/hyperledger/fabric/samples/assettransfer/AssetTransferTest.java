...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            when(stub.getStringState("asset1"))
                .thenReturn("{ \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"Tomoko\", \"appraisedValue\": 300 }");
            Asset duplicate = contract.DuplicateAsset(ctx, "asset1", "Vihan");

            assertThat(duplicate).isEqualTo(new Asset(duplicate.getAssetID(), "blue", 5, "Vihan", 300));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "Vihan");
            });
